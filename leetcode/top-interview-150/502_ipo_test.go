...
// 总之，从给定项目中选择 最多 k 个不同项目，以 最大化最终资本 ，并输出最终可获得的最多资本。
//
// 示例 1：
// 输入：k = 2, w = 0, profits = [1,2,3], capital = [0,1,1]
// 输出：4
// 解释：
// 由于你的初始资本为 0，你仅能从 0 号项目开始。
// 在完成后，你将获得 1 的利润，你的资本变为 1。
// 此时你可以选择开始 1 号或 2 号项目。
// 由于你最多可以选择两个项目，所以你需要选择 2 号项目以获得最大的资本。
// 因此，输出最后最大资本要素，即 0 + 1 + 3 = 4 。
//
// 示例 2：
